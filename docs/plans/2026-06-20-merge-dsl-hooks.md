...
### Task 6: Create ADR 0004 and update CHANGELOG

**Files:**
- Create: `docs/adr/0004-merge-dsl-hooks.md`
- Modify: `CHANGELOG.md`
...
Write `docs/adr/0004-merge-dsl-hooks.md`:

```markdown
# ADR 0004: Merge useFilterDsl into useDslEditor
...
- Added ADR 0004 recording the merge decision.
```

**Step 3: Commit**

```bash
git add docs/adr/0004-merge-dsl-hooks.md CHANGELOG.md
git commit -m "docs: add ADR 0004 and CHANGELOG for DSL hook merge"
```
